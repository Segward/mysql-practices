...
CONSTRAINT delinfo_pk PRIMARY KEY(delnr))ENGINE=INNODB;
...
CONSTRAINT levinfo_pk PRIMARY KEY(levnr))ENGINE=INNODB;
...
CONSTRAINT ordrehode_fk FOREIGN KEY(levnr) REFERENCES levinfo(levnr))ENGINE=INNODB;
...
CONSTRAINT ordredetalj_fk2 FOREIGN KEY(delnr) REFERENCES delinfo(delnr))ENGINE=INNODB;
...
CONSTRAINT prisinfo_fk2 FOREIGN KEY(levnr)REFERENCES levinfo(levnr))ENGINE=INNODB;
