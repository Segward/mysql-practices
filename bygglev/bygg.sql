...
CREATE TABLE poststed(
  ...
  CONSTRAINT poststed_pk PRIMARY KEY(postnr))ENGINE=INNODB;
...
CREATE TABLE borettslag(
  ...
  CONSTRAINT borettslag_pk PRIMARY KEY(bolag_navn))ENGINE=INNODB;
...
CREATE TABLE bygning(
  ...
  postnr SMALLINT NOT NULL,
  CONSTRAINT bygning_pk PRIMARY KEY(bygn_id))ENGINE=INNODB;
...
CREATE TABLE leilighet(
  ...
  CONSTRAINT leilighet_pk PRIMARY KEY(leil_nr))ENGINE=INNODB;
...
CREATE TABLE andelseier(
  ...
  bolag_navn VARCHAR(20) NOT NULL,
  CONSTRAINT andelseier_pk PRIMARY KEY(and_eier_nr))ENGINE=INNODB;
